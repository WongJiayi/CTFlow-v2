...
· [synthetic dataset](https://huggingface.co/datasets/EnyaWoooo/ctflowv2-synthetic-ctrate-valid)
(1,516 volumes, 243GB).
...
Six of the 1,516 outputs from the synthetic CT-RATE validation run
(full HU window, scrolling axial view, one clip per report), picked
before the run finished rather than after — no cherry-picking based on
how any individual volume turned out. The full set is linked below.
...
- Synthetic CT-RATE validation set (1,516 unique reports, one generation
  each, 243GB):
  [huggingface.co/datasets/EnyaWoooo/ctflowv2-synthetic-ctrate-valid](https://huggingface.co/datasets/EnyaWoooo/ctflowv2-synthetic-ctrate-valid)

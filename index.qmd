...
Markdown(tbl.to_markdown(index=False, floatfmt=".2f"))
```
...
<div class="demo-grid">
  ...
  <figure>
    <video src="data/demo_videos/valid_24_a_1.mp4" controls loop muted playsinline></video>
    <figcaption>valid_24_a_1 — "Trachea and both main bronchi are open. No occlusive pathology was detected in the trachea…"</figcaption>
  </figure>
  <figure>
    <video src="data/demo_videos/valid_38_a_1.mp4" controls loop muted playsinline></video>
    <figcaption>valid_38_a_1 — "The size of the thyroid gland has increased and has a heterogeneous appearance…"</figcaption>
  </figure>
</div>
```
